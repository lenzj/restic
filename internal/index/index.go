...
func New(ctx context.Context, repo Lister, ignorePacks restic.IDSet, p *progress.Progress) (idx *Index, invalidFiles restic.IDs, err error) {
	p.Start()
	defer p.Done()
...
func Load(ctx context.Context, repo ListLoader, p *progress.Progress) (*Index, error) {
